            ...
            <div class="card-body">
              ...
              <form method="post">
                ...
                <x-form.input name="current_password" label="Current Password" type="password" required
                  parentClass="mb-5" placeholder="Enter current password" />
                <x-form.input name="password" label="New Password" type="password" bottomInfo="8 characteres or more"
                  required parentClass="mb-4" placeholder="Enter new password"
                  minlength="8" />
                <x-form.input name="password_confirmation" label="Confirm Password" type="password" required
                  parentClass="mb-4" placeholder="Enter new password again" />
