                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <x-form.button defaultText="Filter Students" data-bs-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="get">
                        ...
                        <x-form.select name="course" label="Course" required='true' parentClass="mb-4" optionsType="array"
                            :options="['CSC501', 'CSC502']" />
