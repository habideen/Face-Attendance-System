...
@section('page_title', 'Load Student')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Load Student</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="/{{ Request::segment(1) }}/dashboard">Dashboard</a></li>
                                <li class="breadcrumb-item active">Load Student</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form accept="/admin/load_student" method="post" enctype="multipart/form-data">
                                ...
                                <x-form.button defaultText="Upload Student" class="mt-4" />
